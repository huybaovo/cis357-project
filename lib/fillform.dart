...
final List<String> questions = <String>[
  ...
  'I felt that I spent my time well today.',
  'I ate well today.',
  'I have slept well for today.',
  'I feel energetic.',
  'I feel relaxed and not stressed.',
  'I am optimistic today.',
  'I feel enthusiastic today.',
  'I had a meaningful day',
  'I great about myself today.'
];
                              ...
                              onPressed: () {
                                showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                          title: Text('Oops ><'),
                                          content: Text(
                                              "I'm sorry to hear that, but I can help ^_^"),
                                          actions: [
                                            TextButton(
                                              child: Text('Sure!'),
                                              onPressed: () =>
                              ...
                              onPressed: () {
                                showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                          title: Text('Wow!'),
                                          content: Text(
                                              "That's great. Keep up with the good habit >.< "),
                                          actions: [
                                            TextButton(
                                              child: Text('Thank you ~.~'),
                                              onPressed: () =>
                              ...
                              onPressed: () {
                                showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                          ...
                                          content: Text(
                                              "Hurry complete the form to feel even better ^_^"),
                                          actions: [
                                            TextButton(
